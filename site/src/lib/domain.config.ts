  ...
  entities: [
    {
      name: 'recipe',
      label: 'Receta',
      fields: ['title','slug','region','country','categories','difficulty','prep_time','cook_time','servings','main_ingredients','ingredients','instructions','sensory','nutrition','sources','license','file'],
      xavierKind: 'recipe',
    },
    {
      name: 'ingredient',
      label: 'Ingrediente',
      fields: ['name','scientific_name','group','image','portions','nutrition_per_100g','micronutrients','active_compounds','health_registry','sources','tags'],
      xavierKind: 'ingredient',
    },
    {
      name: 'vitamin',
      label: 'Vitamina / Nutriente',
      fields: ['code','name','group','unit','rda','function','deficiency','sources','ingredient_ids'],
      xavierKind: 'vitamin',
    },
    {
      name: 'flavor',
      label: 'Sabor',
      fields: ['name','profile','intensity','compounds','pairs_with','region_ids'],
      xavierKind: 'flavor',
    },
    {
      name: 'condition',
      label: 'Afección / Beneficio',
      fields: ['name','slug','category','mechanism','evidence_level','compounds','ingredient_ids','recipe_ids','studies'],
      xavierKind: 'condition',
    },
    {
      name: 'diet',
      label: 'Dieta / Capacidad alimenticia',
      fields: ['name','slug','description','rules','allowed_ingredients','forbidden_ingredients','health_goals'],
      xavierKind: 'diet',
    },
    {
      name: 'substance',
      label: 'Substancia / Compuesto bioactivo',
      fields: ['name','formula','discovery_year','source_ingredient','benefit','health_registry','studies','evidence_level'],
      xavierKind: 'substance',
    },
    {
      name: 'technique',
      label: 'Técnica culinaria',
      fields: ['name','category','description','temperature','tools','region'],
    ...
    },
    {
      ...
      fields: ['recipe_id','author','rating','comment','verified','created_at'],
      xavierKind: 'review',
    },
  ],
