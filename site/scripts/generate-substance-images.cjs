...
const substances = [
  ["alicina","Alicina","#9D4EDD"], ["capsaicina","Capsaicina","#F94144"], ["curcumina","Curcumina","#F9C74F"],
  ["gingerol","Gingerol","#90BE6D"], ["piperina","Piperina","#050507"], ["licopeno","Licopeno","#F94144"],
  ["quercetina","Quercetina","#FFB703"], ["cuminaldehido","Cuminaldehído","#8B5CF6"], ["eugenol","Eugenol","#06D6A0"],
  ["anetol","Anetol","#FDE68A"], ["timol","Timol","#84CC16"], ["carvacrol","Carvacrol","#10B981"],
  ["cafeina","Cafeína","#6B3A2A"], ["teobromina","Teobromina","#7C2D12"], ["citral","Citral","#FDE047"],
  ["limoneno","Limoneno","#FEF08A"], ["mentol","Mentol","#06D6A0"], ["apigenina","Apigenina","#F0F9FF"],
  ["resveratrol","Resveratrol","#7C3AED"], ["antocianina","Antocianina","#581C87"], ["betaina","Betaína","#BEF264"],
  ["sulforafano","Sulforafano","#4ADE80"], ["genisteina","Genisteína","#A3A3A3"], ["vanilina","Vanilina","#F5F5DC"],
  ["cinamaldehido","Cinamaldehído","#92400E"], ["oleocanthal","Oleocanthal","#365314"], ["zeaxantina","Zeaxantina","#FACC15"],
  ["dodecenal","Dodecenal","#059669"], ["linalool","Linalool","#C4B5FD"], ["alil-isotiocianato","Alil-ITC","#DC2626"]
];
